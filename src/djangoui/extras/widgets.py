...
class SelectTimeWidget(Widget):
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=False, show_seconds=None):
        """
...
#            hour_val = 12
    ...
    def value_from_datadict(self, data, files, name):
        ...
        h = data.get(self.hour_field % name, '') # hour
        m = data.get(self.minute_field % name, '') # minute 
        s = data.get(self.second_field % name, '') # second
